<ol class="breadcrumb">
   <li><a><i class="fa fa-calendar"></i>  Nilai Mahasiswa</a></li>
  ...
  <thead>
    ...
    ?>
      <tr>
          ...
          <a href="<?= base_url('dsn/data_nilai/' . $value['id_jadwal']) ?>" class="btn btn-success btn-sm"><i class="fa fa-calendar"> Nilai</i></a>
          </td>
      </tr>
    <?php } ?>
    </tbody>
