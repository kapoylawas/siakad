<div class="row">
    ...
    <?php echo form_open('prodi/update/' . $prodi['id_prodi']); ?>
           ...
           <div class="form-group">
             ...
             <input name="kode_prodi" value="<?= $prodi['kode_prodi'] ?>" class="form-control" placeholder="Kode Progam Studi" readonly>
           </div>
           <div class="form-group">
             <label>Progam Studi</label>
             <input name="prodi" value="<?= $prodi['prodi'] ?>" class="form-control" placeholder="Progam Studi">
           </div>
           <div class="form-group">
             <label>Jenjang</label>
             <select name="jenjang" class="form-control select2" style="width: 100%;">
