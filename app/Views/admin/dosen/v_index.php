    ...
    <div class="box box-danger box-solid">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <a href="<?= base_url('dosen/add') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> add</a>
              </div>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
                  ...
                  <?php $no = 1; 
                   foreach ($dosen as $key => $value) { ?>
                    <tr>
                        ...
                        <td class="text-center"><img src="<?= base_url('foto_dosen/' . $value['foto_dosen']) ?>" class="img-circle" width="40px" height="40px"></td>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                 Apakah Anda Yakin Ingin Menghapus Dosen <b><?= $value['nama_dosen'] ?> ..?</b>
              </div>
